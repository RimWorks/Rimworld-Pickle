...
/// <summary>
/// How close a stat has to be to count as equal. Flat breaks on MarketValue in the
/// thousands and relative breaks near zero, so a comparison takes whichever is looser.
/// </summary>
